...
// Маппинг старых subcategory ID → названия подкатегорий
...
// Маппинг старых названий подкатегорий → новые названия (из CategoriesData)
...
// Старые skillInterests из users.json для каждого пользователя (по порядку)
